...
<grok-card data-id="0a5c44" data-type="image_card"></grok-card>


My core expertise is in **Java**, **TypeScript**, **Node.js**, and **AWS**—deploying reliable services with Lambda, DynamoDB, S3, EKS, Kafka, and more.

Recently, I've expanded into **Python** for data science and AI, building end-to-end ML projects with Hugging Face Transformers and Gradio.

<grok-card data-id="aca30e" data-type="image_card"></grok-card>



<grok-card data-id="35725c" data-type="image_card"></grok-card>
